# Generated by Powerlevel10k configuration wizard on 2019-10-03 at 20:48 EDT.
# Based on romkatv/powerlevel10k/config/p10k-lean.zsh.
# Wizard options: awesome-fontconfig + powerline, large icons, lean, time, 2 lines,
# dotted, sparse, few icons, concise.
...
() {
  ...
  # Icon color.
  typeset -g POWERLEVEL9K_VCS_VISUAL_IDENTIFIER_COLOR=197
  # Custom icon.
  ...
  # typeset -g POWERLEVEL9K_VCS_LEFT_SEGMENT_SEPARATOR=$'\uE0B1'
  ...
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE="%F{"4"}corinne%F{"250"}@%F{"63"}%m"
